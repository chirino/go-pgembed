...
#cgo darwin LDFLAGS: -L./rust_lib/target/release -lrust_pg_embedded_lib -ldl -lm -framework Security -framework CoreFoundation -framework SystemConfiguration -llzma
#cgo linux LDFLAGS: -L./rust_lib/target/release -lrust_pg_embedded_lib -ldl -lm -lrt -lpthread -llzma
#cgo windows LDFLAGS: -L./rust_lib/target/release -lrust_pg_embedded_lib -lws2_32 -luserenv -ladvapi32 -lbcrypt -lntdll -llzma
